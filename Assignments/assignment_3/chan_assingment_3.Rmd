...
# new data frame to store max power
 # we've forund the mean power over a range of speeds, now we find max of each car over our 300 iterations 
power_all_cars_max <- as.data.frame(matrix(nrow = length(speeds), ncol = nrow(possible_cars)))
```
